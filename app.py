...
# ==========================================
st.set_page_config(page_title="BIST Trading & Screener Terminal", layout="wide")
...
st.title("⚡ BIST Algo-Trading & Tarama Terminali")

# SEKMELİ YAPI (TABS)
tab1, tab2 = st.tabs(["🔍 Hisse Taraması (Screener)", "📊 Scalp & Detaylı Analiz"])

# ==========================================
# TAB 1: HİSSE TARAMA PANELİ (SCREENER)
# ==========================================
with tab1:
    st.subheader("🔎 BIST Hızlı Tarama Modülü")
    watch_list = st.text_area("Taranacak Hisseler (Virgülle Ayırın)", "THYAO.IS, GARAN.IS, EREGL.IS, AKBNK.IS, SISE.IS, TUPRS.IS")
        ...
        for i, t in enumerate(tickers):
            try:
                ...
                if not data.empty:
                    ...
                    signal = "NÖTR"
                    if last_c > last_vwap and last_rsi > 50:
                        signal = "🔥 GÜÇLÜ AL"
